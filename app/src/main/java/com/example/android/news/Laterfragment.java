...
public class Laterfragment extends Fragment {
    ...
    String imgurl, url, des, author, titles, date, humanauthor;
    ProgressBar pbar;
    ...
    void createlist() {
        ...
        for (int i = 0; i < book.size(); i++) {
            ...
            humanauthor = book.gethumanauthors().get(i);
            article thisarticle = new article(imgurl, url, des, author, titles, date, humanauthor);
